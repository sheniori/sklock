...
namespace Sklok.Classes {
    ...
    public class Win32 {
        ...
        [DllImport("kernel32.dll")]
        public static extern int SetThreadPriority(int hThread, int nPriority);

        [DllImport("kernel32.dll")]
        public static extern int SetPriorityClass(int hProcess, int dwPriorityClass);

        [DllImport("kernel32.dll")]
        public static extern int CreateProcess(string lpApplicationName, string lpCommandLine, int lpProcessAttributes, int lpThreadAttributes, int bInheritHandles, int dwCreationFlags, int lpEnvironment, string lpCurrentDriectory, ref STARTUPINFO lpStartupInfo, ref PROCESS_INFORMATION lpProcessInformation);
        ...
        public static extern long GetVersionExA(OSVERSIONINFO lpVersionInformation);
        ...
        [DllImport("user32.dll")]
        public static extern int OpenInputDesktop(int dwFlags, Boolean fInherit, int dwDesiredAccess);
        ...
        [DllImport("user32.dll")]
        public static extern int SetThreadDesktop(int hDesktop);

        [DllImport("user32.dll")]
        public static extern int SwitchDesktop(int hDesktop);

        [DllImport("user32.dll")]
        public static extern int CloseDesktop(int hDesktop);

        [DllImport("user32.dll")]
        public static extern int GetUserObjectInformation(int hObj, int nIndex, StringBuilder pvInfo, int nLength, ref int lpnLengthNeeded);

        [DllImport("user32.dll")]
       public  static extern int SystemParametersInfo(int uAction, bool uParam, bool lpvParam, int fuWinIni);
        ...
        #region "Constants"
       public  static const uint INFINITE = 0xFFFFFFFF;
        public static const int UOI_NAME = 2;
        public static const int GENERIC_ALL = 0x10000000;
        public static const int DESKTOP_SWITCHDESKTOP = 0x100;
        public static const int NORMAL_PRIORITY_CLASS = 0x00000020;
        public static const int THREAD_BASE_PRIORITY_MAX = 2;
        public static const int REALTIME_PRIORITY_CLASS = 0x100;
        #endregion
    }
